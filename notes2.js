...
<div style="float: left;width: 650px;">
    <div style="float: left; width: 650px;">
        <p><b>Dear ${reservations[0]?.passengerDetails?.firstname
        }</b></p>
        ...
        ${meetPoint.length > 0
            ? ` <p>
                                      <span style="font-weight:bold;">Meeting your driver:</span>
                                       ...
                                       <span>
                                     Our Meeting Point at ${reservations[0]?.selectedPickupPoints[0]?.address}:
                                       </span>
            ...
            <table width="650" border="1" cellpadding="0" cellspacing="0"
                ...
                <tbody>
                    <tr style="width:100%;">
                        ...
                        <td style="padding:2px;padding-left: 3px ;width: 450px !important">${reservId[0][0]
                        }</td>
                    </tr>
                    <tr style="width:100%;">
                        <td style="font-weight:bold;width: 200px !important;padding-left: 3px">Lead Passenger Name
                        </td>
                        <td style="padding:2px;padding-left: 3px;width: 450px !important">${reservations[0]
                            ?.passengerDetails
                            ?.firstname
                        } </td>
                    </tr>
                    <tr style="width:100%;">
                        ...
                        <td style="padding:2px;width:450px !important">${reservations[0]
                            ?.transferDetails
                            ?.passengersNumber
                        } </td>
                    </tr>
                    ...
                    <tr style="width:100%;">
                        ...
                        <td style="padding:2px;padding-left: 3px;width: 450px !important"><a href="">${reservations[0]
                            ?.passengerDetails
                            ?.email
                        }
                        </a>
        ...
        <div style="float: left;width: 650px; ">
            <table width="650" border="1" class="xtable_mr_css_attr" cellpadding="0" cellspacing="0"
                ...
                <tbody>
                    ${reservations[0].selectedPickupPoints.map(
                        (point) =>
                            `
                                                  <tr>
                                                  <td style="font-weight:bold;width: 200px !important;padding-left: 3px">
                    ...
                    ${reservations[0].selectedDropoffPoints.map(
                        (point) =>
                            `
                                                  <tr>
                                                  <td style="font-weight:bold;width: 200px !important;padding-left: 3px">
                    ...
                    <tr style="width:100%;">
                        <td style="font-weight:bold;width: 200px !important;padding:2px 3px;">${reservations[0]
                        ...
                        <td style="padding:2px"><span>
                            ${reservations[0].transferDetails?.transferDateTimeString.split(
                                " "
                            )[0]
                            }
                    ...
                    <tr style="width:100%;">
                        ...
                        <td style="padding:2px">${vehicleTypes[0]
                        }</td>
                    </tr>
                    <tr style="width:100%;">
                    ...
                    <tr style="width:100%;">
                        ...
                        <td style="min-height: 29px;padding:2px">${reservations[0]
                            .transferDetails
                            ?.specialRequests
                        }</td>
                    </tr>
        ...
        ${reservations[1]?.quotation?.price
      ...
      >
        ...
        <tbody>
          ...
          <tr style="width:100%;">
            ...
            <td style="padding:2px;padding-left: 3px;;width: 450px !important">
              ${reservations[1]?.passengerDetails?.firstname}
            </td>
          </tr>
          <tr style="width:100%;">
            <td style="font-weight:bold;width: 200px !important;padding-left: 3px">
            ...
            <td style="padding:2px;width: 450px !important">
              ${reservations[1]?.transferDetails?.passengersNumber}
            </td>
          </tr>
          <tr style="width:100%;">
            <td style="font-weight:bold;width: 200px !important;padding-left: 3px">
            ...
            <td style="padding:2px;padding-left: 3px;width: 450px !important">
              ...
              ${reservations[1]?.passengerDetails?.phone}
            </td>
          </tr>
          <tr style="width:100%;">
            <td style="font-weight:bold;width: 200px !important;padding-left: 3px">
            ...
            <td style="padding:2px;padding-left: 3px;width: 450px !important">
              <a href="">
                ${reservations[1]?.passengerDetails?.email}
              </a>
            </td>
          </tr>
        </tbody>
